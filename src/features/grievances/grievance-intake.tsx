...
const intakeCopy = {
  en: {
    ...
    description: "Grievance description", descriptionBody: "Provide the service details relevant dates and the action requested.", what: "What happened?", placeholder: "Example: I applied for… on… but…", characters: "characters", voice: "Speak grievance", sample: "Use realistic sample", before: "Before you continue", publicService: "This is about public-service delivery.", publicBody: "I understand emergencies, court matters, RTI and religious matters use another channel.", save: "Save and exit", understanding: "Understanding your issue…", understand: "Understand and suggest route",
    ...
    <div className={styles.journey}>
      ...
      <section className={styles.workspace}>
        {step === 1 ? <form onSubmit={analyse}>
          ...
          <div className={styles.assistRow}><button className={styles.voiceButton} onClick={() => setError("Voice input needs browser microphone permission. For this reliable demo, use the sample or type the grievance.")} type="button"><span aria-hidden="true">●</span> {copy.voice}</button><button className={styles.sampleButton} onClick={() => { setDescription(sample); setError(""); }} type="button">{copy.sample}</button></div>
